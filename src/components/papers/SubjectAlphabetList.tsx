              ...
              ${
                  availableLetters.has(letter)
                      ? activeSection === letter
                          ...
                          : hoverLetter === letter
                          ? "bg-blue-500/60 text-white border border-blue-400/60"
                          : "bg-blue-400/40 text-blue-900 dark:text-blue-100 hover:bg-blue-500/60 hover:text-white hover:border hover:border-blue-400/60"
                    ...
                    return (
                        ...
                        >
                            <div className="flex items-center mb-6">
                                <h2 className="flex h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 items-center justify-center rounded-md bg-blue-600/70 text-xl sm:text-2xl font-bold text-white shadow-sm">
                                    {letter}
                                </h2>
                                        ...
                                        >
                                            <div className="inline-block relative">
                                                <button
                                                    ...
                                                    className="text-left py-2 px-1 text-content group-hover:text-content/80 transition-colors duration-200"
                                                >
                                                    {subject}
                                                </button>
